...
export const LAYER_CONFIG = {
  strefy: { name: 'Obrys i Wymiary', Icon: Layers, color: '#94a3b8', group: 'Architektura' },
  ...
  kanalizacja: { name: 'Kanalizacja', Icon: Droplets, color: '#8b5cf6', group: 'Wodno-Kanalizacyjne' },
  elektryka_punkty: { name: 'Punkty i Urządzenia', Icon: Zap, color: '#eab308', group: 'Instalacja Elektryczna' },
  elektryka_trasy: { name: 'Kable i Trasy', Icon: Activity, color: '#f59e0b', group: 'Instalacja Elektryczna' }
};
