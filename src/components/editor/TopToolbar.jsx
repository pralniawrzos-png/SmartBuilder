...
import { ArrowLeft, BarChart2, PenTool, XCircle, Save, Download, Menu, X } from 'lucide-react';

export default function TopToolbar({
  projectName, onClose, isEditMode, showStats, setShowStats,
  toggleEditMode, cancelEditMode, handleExportData,
